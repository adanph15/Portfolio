    ...
    return (
        <div className='lg:w-2/3 sm:w-full p-10'>
            ...
            <div className='flex flex-col gap-4 items-start mt-20'>
                <h1 className='text-4xl font-bold tracking-tight text-slate-200 sm:text-5xl'>Hello, <span className='text-cyan-400 font-bold'>I am Adán Pérez</span> </h1>
            ...
            <div className="mb-12 mt-8">
                ...
                <div className="flex flex-row items-center gap-4 mt-8">
                    <button className="download-button relative flex flex-row items-center rounded-full bg-cyan-400/10 hover:bg-cyan-600/10 hover:text-transparent px-4 py-2 text-base font-medium leading-5 text-teal-300 gap-4 transition-all duration-300 ease-in-out group border border-transparent hover:border-teal-100">
                        <p className="download-button__text">Download CV</p>
                        <FontAwesomeIcon icon={faDownload}  className="download-button__icon absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center justify-center transition-all duration-300 text-transparent group-hover:text-teal-100" />
                    </button>
